...
<!--main banner-->
    <section class = "category-container">
        <a href="PC.html" class = "categories">
            <img src = "images/PCHero.jpg" alt = "">
            <p class = "category-title">PC <br> Systems</p>
        </a>
    ...
    <section class = "product">
        <h2 class = "product-category">PCs</h2>
        ...
        <div class = "product-container">
            <div class = "product-card">
                    <div class = "product-image">
                        <img src = "images/ni_item.png" class = "product-thumb" alt = "">
                    ...
                    $sql = "SELECT p_name, product_price from products natural join inventory where inventory_id = p_id  and  p_id REGEXP '11'";
