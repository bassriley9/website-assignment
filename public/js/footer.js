    ...
    <div class = "footer-content">
        ...
        <div class = "footer-ul-container">
            <ul class = "cat">
                ...
                <li><a href="consoles.php" class = "footer-link">Consoles</a></li>
                <li><a href="laptops.php" class = "footer-link">Laptops</a></li>
                <li><a href="PC.php" class = "footer-link">PCs</a></li>
                <li><a href="Game.php" class = "footer-link">VideoGames</a></li>
                <li><a href="other.php" class = "footer-link">Other</a></li>
